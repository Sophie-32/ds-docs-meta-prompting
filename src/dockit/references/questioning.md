...
All questions should follow the voice defined in @{AGENT_FOLDER}/dockit/references/style-guide.md — approachable, precise, and authoritative without being arrogant.
...
- The user has addressed the guiding questions for that section (see @{AGENT_FOLDER}/dockit/references/sections.md)
